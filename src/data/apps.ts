...
const apps: App[] = [
  ...
  // ── ROADMAP ──────────────────────────────────────────
  // Team
  { name: "Daily", slug: "daily", emoji: "☀️", desc: "Free async standups and team check-ins directly in Slack", features: ["Customizable standup questions", "Scheduled posting (weekdays, daily, MWF)", "Mood tracking", "Threaded responses in channel", "DM reminders to respond", "Recent session history"], pricing: "Free", category: "Team", tags: ["Team", "Free"], status: "roadmap" },
  { name: "Timer", slug: "timer", emoji: "⏱️", desc: "Start, stop, and track time directly in Slack", features: ["One-click start/stop timer", "Auto project detection", "Manual time entry", "Weekly summaries by project", "Billable hour tagging", "Long-timer reminders"], pricing: "Free", category: "Ops", tags: ["Ops", "Free"], status: "roadmap" },
