...
const apps: App[] = [
  ...
  { name: "Pulse", slug: "pulse", emoji: "😊", desc: "Anonymous team mood check-ins", features: ["Weekly anonymous pulse", "Trend graphs over time", "Flag low morale early", "Optional follow-up prompts"], pricing: "Free", category: "Team", tags: ["Team", "Free"], status: "roadmap" },
